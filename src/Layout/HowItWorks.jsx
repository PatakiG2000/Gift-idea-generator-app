export default function HowItWorks() {
  return (
    <>
      <section
        id="how-it-works"
        class="pt-24 pb-28 bg-white overflow-hidden z-0"
      >
        <div class="container px-4 mx-auto">
          <h2 class="mb-5 text-6xl md:text-7xl text-center font-bold font-heading tracking-px-n leading-tight">
            How the magic works
          </h2>
          <p class="mb-20 text-lg text-gray-900 text-center font-medium md:max-w-lg mx-auto">
            With just a few simple steps, the user can choose the perfect gift
            and watch the recipient's smile light up.
          </p>
          <div class="flex flex-wrap -m-8">
            <div class="w-full md:w-1/3 p-8">
              <div class="relative text-center">
                <img
                  class="absolute -right-40 top-8 hidden md:block"
                  src="https://tailwindsites.com/images/themes/happy/line.svg"
                  alt=""
                />
                ...
                <div class="md:max-w-xs mx-auto">
                  ...
                  <p class="font-sans text-gray-600">
                    With just a few simple questions, we're able to get a sense
                    of your gift needs and preferences.
                  </p>
                </div>
              </div>
            </div>
            <div class="w-full md:w-1/3 p-8">
              <div class="relative text-center">
                ...
                <div class="md:max-w-xs mx-auto">
                  ...
                  <p class="font-sans text-gray-600">
                    An advanced AI algorithms then use this information to
                    generate a list of unique and thoughtful gift ideas.
                  </p>
                </div>
              </div>
            </div>
            <div class="w-full md:w-1/3 p-8">
              <div class="text-center">
                ...
                <div class="md:max-w-xs mx-auto">
                  <h3 class="mb-5 font-heading text-xl font-bold font-heading leading-normal">
                    Giving Out the Ideas
                  </h3>
                  <p class="font-sans text-gray-600">
                    All that's left is for you to choose the perfect gift, sit
                    back, and watch the smile on their face as they receive it!
                  </p>
                </div>
              </div>
            </div>
